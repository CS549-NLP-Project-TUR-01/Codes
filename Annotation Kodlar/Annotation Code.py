...
SENTIMENT_WORDS = {
    "Olumlu": [
        "mükemmel", "harika", "gerçekçi", "akıcı", "kaliteli", "tavsiye", "güzel", "iyi",
        "büyüleyici", "en iyi", "beğeni", "üstün", "fevkalade", "olağanüstü", "göz alıcı",
        "muhteşem", "etkileyici", "cazip", "özenli", "profesyonel", "başarılı", "takdir",
        "memnun", "harikulade", "nefes kesici", "şaheser", "akıl almaz", "sürükleyici",
        "bağımlılık yapan", "unutulmaz", "yenilikçi", "övgü", "taktir", "alkış", "müthiş",
        "kusursuz", "ideal", "parlak", "dahice", "keyifli", "sarıyo", "sarıyor", "oynayın",
        "zevkli", "süper", "başyapıt", "aşık", "aşk", "baş yapıt", "efsane", "mük", "kalite",
        "taş", "inanılmaz", "mükemmel",
    "harika",
    "gerçekçi",
    "akıcı",
    "kaliteli",
    ...
    "Olumsuz": [
        "kötü", "oynamayın", "kanser", "berbat", "hatalı", "yavaş", "sıkıcı", "donuk", "zayıf",
        "kötücül", "işe yaramaz", "eksik", "yetersiz", "kaba", "acımasız", "düzensiz",
        "hayal kırıklığı", "verimsiz", "mutsuz", "çirkin", "fiyasko", "tatsız", "tekdüze",
        "vasat", "sinir bozucu", "tutarsız", "başarısız", "kırık", "çöküyor", "dengesiz",
        "kafa karıştırıcı", "pişman", "iğrenç", "rezil", "kalitesiz", "dayanılmaz", "bozuk",
        "çöp", "almayın", "kötü",
    "berbat",
    "hatalı",
    "yavaş",
